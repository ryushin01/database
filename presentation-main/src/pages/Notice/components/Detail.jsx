            ...
            <section className="w-full py-6">
              <div className="flex flex-col items-center gap-y-6">
                ...
                <ul className="grid grid-cols-2 gap-y-6 w-full">
                  ...
                  <li className="flex flex-col items-center gap-y-2">
                    <img src="/presentation/images/member/js1.png" alt="진선" className="w-20 h-20"/>
                    <span className="text-base md:text-lg">진선</span>
                  </li>
                  <li className="flex flex-col items-center gap-y-2">
                    <img src="/presentation/images/member/js2.png" alt="지수" className="w-20 h-20"/>
                    <span className="text-base md:text-lg">지수 님</span>
                  </li>
                  <li className="flex flex-col items-center gap-y-2">
