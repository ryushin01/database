 ...
 * @property {string} id                    - 라벨링을 위한 아이디
 ...
 * @property {boolean} isExcludingPast      - 오늘 날짜 이전의 날짜 선택 불가
 * @property {boolean} isError              - 미입력 시 에러 처리
 */
export default function DatePicker({
                                     ...
                                     required = false,
                                     isExcludingPast = false,
                                     minDate = null,
                                     isError = false,
                                   }: DatePickerProps) {
  return (
    <>
      <div className={`_datepicker ${isError ? "_error" : ""}`}>
        ...
        <ReactDatePicker
          ...
          // 오늘 날짜 이전의 날짜 선택 불가
          minDate={
            !!minDate ? minDate : isExcludingPast ? new Date() : undefined
          }
          // 자동 완성 옵션
          autoComplete="off"
          name={name}
