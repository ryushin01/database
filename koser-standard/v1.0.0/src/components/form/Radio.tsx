...
import { RadioUncheckedIcon, RadioCheckedIcon } from "@icons20";
 ...
 * @property {boolean} isDesktop        - 데스크탑 해상도 진입 여부
 */
  ...
  return (
    <label className={className}>
      ...
      <Image
        ...
        height={20}
      />
      <Typography kind={isDesktop ? "title-small" : "body-medium"}>{labelText}</Typography>
    </label>
  );
}
