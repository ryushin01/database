  ...
  return (
    <div className="flex flex-1">
      <Grid className="without-padding">
        <GridItem mobile={12} tablet={12} desktop={4}>
          <section
        ...
        <GridItem mobile={12} tablet={12} desktop={4}>
          <section
            ...
            "
          >
            <Link to={LIST_DATA[2].path} className="flex justify-center items-center flex-col gap-y-6 w-full h-full absolute inset-0 z-10">
              <h1 className="text-5xl lg:text-8xl text-grayscaleF font-bold drop-shadow-2xl">{LIST_DATA[2].title}</h1>
              <h2 className="text-xl lg:text-4xl text-grayscaleF font-normal drop-shadow-2xl">{LIST_DATA[2].subtitle}</h2>
            </Link>
            <img src={LIST_DATA[2].bg} alt="" className="w-full h-full z-1 object-cover" />
          </section>
        </GridItem>
      </Grid>
    </div>
